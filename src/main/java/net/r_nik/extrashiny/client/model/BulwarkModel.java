...
public class BulwarkModel extends Model {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath(ExtraShiny.MOD_ID, "bulwark"), "main");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        partdefinition.addOrReplaceChild("plate", CubeListBuilder.create()
                        .texOffs(0, 0).addBox(-11.0F, -30.0F, -1.0F, 12.0F, 30.0F, 2.0F, new CubeDeformation(0.0F))
                        .texOffs(28, 0).addBox(-14.0F, -27.0F, -1.0F, 3.0F, 21.0F, 2.0F, new CubeDeformation(0.0F))
                        .texOffs(28, 23).addBox(1.0F, -27.0F, -1.0F, 3.0F, 21.0F, 2.0F, new CubeDeformation(0.0F)),
                PartPose.offset(5.0F, 21.0F, 0.0F));

        partdefinition.addOrReplaceChild("handle", CubeListBuilder.create()
                        .texOffs(0, 32).addBox(-6.0F, -19.0F, 1.0F, 2.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)),
                PartPose.offset(5.0F, 21.0F, 0.0F));
